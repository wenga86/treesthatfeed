...
ActiveRecord::Schema.define(:version => 20140308174453) do
  ...
  create_table "profiles", :force => true do |t|
    ...
    t.string "nicename"
    t.text   "modules"
    t.string "cntrl",    :default => "admin/dashboard"
    t.string "actn",     :default => "index"
  end
  ...
  create_table "users_types", :id => false, :force => true do |t|
    t.integer "user_id"
    t.integer "type_id"
  end

  add_index "users_types", ["user_id", "type_id"], :name => "index_users_types_on_user_id_and_type_id"
