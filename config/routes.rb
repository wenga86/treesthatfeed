Rails.application.routes.draw do
  ...
  %w{advanced cache categories comments content profiles general pages feedback
     resources sidebar textfilters themes trackbacks users settings tags redirects seo post_types albums }.each do |i|
    match "/admin/#{i}", :to => "admin/#{i}#index", :format => false
    match "/admin/#{i}(/:action(/:id))", :to => "admin/#{i}", :action => nil, :id => nil, :format => false
  end

  # default
  root :to  => 'articles#view_page', :name => 'index', :format => false

  #Trees That Feed Override
  match "/about", :to => "articles#view_page", :name => 'about', :format => false
  match "/partners", :to => "articles#view_page", :name => 'partners', :format => false
  match "/breadfruit-tree", :to => "articles#view_page", :name => 'breadfruit-tree', :format => false
  match "/moringa-tree", :to => "articles#view_page", :name => 'moringa-tree', :format => false
  match "/pigeon-pea-tree", :to => "articles#view_page", :name => 'pigeon-pea-tree', :format => false
  match "/pomegranate-tree", :to => "articles#view_page", :name => 'pomegranate-tree', :format => false
  match "/other-trees", :to => "articles#view_page", :name => 'other-trees', :format => false
  match "/donate", :to => "articles#view_page", :name => 'donate', :format => false
  match "/news", :to => "articles#view_page", :name => 'news', :format => false
  match "/ackee-tree", :to => "articles#view_page", :name => 'ackee-tree', :format => false
  match "/articles", :to => "articles#index", :format => false
